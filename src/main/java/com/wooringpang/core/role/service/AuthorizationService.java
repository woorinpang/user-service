package com.wooringpang.core.role.service;
...
import com.wooringpang.core.role.repository.AuthorizationQueryRepository;
import com.wooringpang.core.role.repository.AuthorizationRepository;
import com.wooringpang.core.role.domain.Authorization;
import com.wooringpang.core.role.exception.AuthorizationNotFoundException;
import com.wooringpang.core.role.presentation.request.UpdateAuthorizationRequest;
import com.wooringpang.global.config.GlobalConstant;
...
public class AuthorizationService extends AbstractService {
    ...
    public Boolean isAuthorization(HttpServletRequest request, Authentication authentication) {
        ...
        return isContainMatch(authorizations, request.getMethod(), GlobalConstant + request.getRequestURI());
    }
